...
>
> 🔴 **2026-06-19 重大更新: 本表の旧 ✅(セッション4〜17b)は density393 で再照合するまで「未検証」扱い。**
> 今セッションで **density 393(iPhone 17 Pro Max 幅一致)+ golden 横並び**再照合した結果、旧 ✅ 画面から
> 実バグを 8 件超発見・是正した(週ストリップ◎/@username/共有グラデ/**体重達成リング欠落**/crown/絵文字/炎)。
> **動く残タスク台帳は `docs/PARITY_REMAINING_TASKS.md`(体系的バックログ)を正本とする。** 本表は履歴記録として保持。
>
